...
public class CustomerExperienceActivity extends BaseActivity implements  NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_experience);

        //Side Menu and toolbar
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar_cuse);
        toolbar.setTitle("");
        setSupportActionBar(toolbar);
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout_cuse);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        DrawerLayout mDrawerLayout = (DrawerLayout) findViewById(R.id.drawer_layout_cuse);
